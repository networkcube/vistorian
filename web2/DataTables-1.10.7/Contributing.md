...
5. Pull requests will only be accepted if you acknowllink that your contribution is offered under and will be made available under the project's existing license (MIT). If your initial pull request doesn't explicitly acknowllink this I'll ask before it is pulled in.